#    Filename: virtualizer.py		 Created: 2016-12-05  20:18:06
...
class GroupingNode(GroupingId_name_type, GroupingLinks, GroupingMetadata):
    ...
    def __init__(self, tag, parent=None, id=None, name=None, type=None, status=None, ports=None, links=None, resources=None, constraints=None):
        GroupingId_name_type.__init__(self, tag, parent, id, name, type)
        GroupingLinks.__init__(self, tag, parent, links)
        GroupingMetadata.__init__(self, tag, parent)
        self._sorted_children = ["id", "name", "type", "status", "ports", "links", "resources", "constraints", "metadata"]
        # yang construct: leaf
...
class GroupingInfra_node(GroupingNode, GroupingFlowtable):
    def __init__(self, tag, parent=None, id=None, name=None, type=None, status=None, ports=None, links=None, resources=None, constraints=None, NF_instances=None, capabilities=None, flowtable=None):
        GroupingNode.__init__(self, tag, parent, id, name, type, status, ports, links, resources, constraints)
        GroupingFlowtable.__init__(self, tag, parent, flowtable)
        self._sorted_children = ["id", "name", "type", "status", "ports", "links", "resources", "constraints", "metadata", "NF_instances", "capabilities", "flowtable"]
        # yang construct: container
...
class GroupingVirtualizer(GroupingId_name, GroupingLinks, GroupingMetadata):
    ...
    def __init__(self, tag, parent=None, id=None, name=None, nodes=None, links=None, version='2016-07-08; compiled at 2016-12-05  20:18:06'):
        GroupingId_name.__init__(self, tag, parent, id, name)
        GroupingLinks.__init__(self, tag, parent, links)
        GroupingMetadata.__init__(self, tag, parent)
...
class Node(ListedYang, GroupingNode):
    def __init__(self, tag="node", parent=None, id=None, name=None, type=None, status=None, ports=None, links=None, resources=None, constraints=None):
...
class Infra_node(ListedYang, GroupingInfra_node):
    def __init__(self, tag="node", parent=None, id=None, name=None, type=None, status=None, ports=None, links=None, resources=None, constraints=None, NF_instances=None, capabilities=None, flowtable=None):
        ListedYang.__init__(self, "node", ["id"])
        GroupingInfra_node.__init__(self, tag, parent, id, name, type, status, ports, links, resources, constraints, NF_instances, capabilities, flowtable)
        self._sorted_children = ["id", "name", "type", "status", "ports", "links", "resources", "constraints", "metadata", "NF_instances", "capabilities", "flowtable"]
...
class Virtualizer(GroupingVirtualizer):
    def __init__(self, tag="virtualizer", parent=None, id=None, name=None, nodes=None, links=None, version='2016-07-08; compiled at 2016-12-05  20:18:06'):
